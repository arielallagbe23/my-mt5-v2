...
export const api = {
  ...
  scheduleOrder: (order) => request('/api/set-order/schedule', { method: 'POST', body: order }),
  scheduledOrders: () => request('/api/set-order/scheduled'),
  cancelScheduledOrder: (id) => request(`/api/set-order/scheduled/${id}`, { method: 'DELETE' }),
